...
# Function to create and start container using bind mounts
init_container() {
    ensure_user_in_docker_group
    local repo_url=$1
    local repo_name
    ...
    # Set up project directory and container names
    ...
    # Use bind mounts directly, removing any reference to Docker volumes
